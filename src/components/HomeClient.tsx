            ...
            <section className="min-h-screen flex flex-col items-center justify-center relative bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-zinc-900 via-zinc-950 to-black overflow-hidden px-4 py-24 md:py-32">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-400 text-xs sm:text-sm md:text-base mb-8 animate-pulse backdrop-blur-sm">
                        ...
                        <span>{renderEmojiText(content.scroll_down_text || "Scroll Down for More!")}</span>
                    </div>

                    <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-pink-100 to-zinc-500 mb-6 tracking-tighter leading-[1.1] relative select-none cursor-pointer whitespace-nowrap" onClick={handleHeartClick}>
                        <Sparkles className="inline-block mr-2 md:mr-4 animate-pulse w-6 h-6 md:w-10 md:h-10" color="#ec4899" />
                        <TypewriterText text={content.hero_title || "Happy Birthday Mohini ❤️"} speed={150} />
                    </h1>

                    <p className="text-base md:text-2xl text-zinc-400 mt-4 max-w-xl mx-auto leading-relaxed px-4 italic">
                ...
                >
                    <p className="text-zinc-500 text-sm">{renderEmojiText(content.scroll_karo_text || "Scroll Karo 👇")}</p>
                </div>
            </section>
            ...
            <section className="min-h-[60vh] flex items-center justify-center py-20 px-6 bg-zinc-950 relative overflow-hidden">
                ...
                <div className="max-w-3xl text-center space-y-8 z-10">
                    ...
                    <div className="relative p-8 md:p-12 bg-zinc-900/50 backdrop-blur-xl rounded-3xl border border-white/5 shadow-2xl">
                        <div className="text-lg md:text-xl text-zinc-300 leading-loose space-y-6 font-light whitespace-pre-wrap text-left md:text-center italic">
                            ...
                            {!vaultUnlocked ? (
                                <div className="p-8 md:p-12 text-center space-y-8">
                                    ...
                                    <div className="space-y-2">
                                        <h3 className="text-3xl font-black text-white tracking-tighter uppercase">{renderEmojiText(content.secret_vault_title || "Secret Vault 🔒")}</h3>
                                        <p className="text-zinc-500 text-sm font-medium">{renderEmojiText(content.secret_vault_hint || "Enter your Birth Date (DDMM) to unlock.")}</p>
                                    </div>
                                ...
                                <>
                                    ...
                                    <div className="flex-1 overflow-y-auto px-8 md:px-12 py-8 custom-scrollbar">
                                        <div className="relative">
                                            ...
                                            <p className="text-xl md:text-2xl text-zinc-100 leading-relaxed italic text-center relative z-10 py-4">
