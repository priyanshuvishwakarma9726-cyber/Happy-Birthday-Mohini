                ...
                {open && (
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-xl md:text-2xl text-zinc-400 italic max-w-lg mx-auto leading-relaxed">
                                {renderEmojiText("Chahe kal jo bhi ho, mera aaj aur aane wala har pal sirf tumhara hai. ❤️")}
                            </p>
