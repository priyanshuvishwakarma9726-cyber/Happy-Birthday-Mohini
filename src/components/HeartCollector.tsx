    ...
    return (
        <div className="relative w-full max-w-md mx-auto aspect-[3/4] bg-zinc-900 rounded-3xl overflow-hidden border-4 border-pink-500/50 shadow-2xl">
            ...
            <div className="absolute top-4 w-full text-center z-20">
                <span className="bg-pink-600 px-4 py-1 rounded-full text-white font-bold shadow-lg text-sm flex items-center justify-center gap-1 mx-auto w-fit">
            ...
            <AnimatePresence>
                {gameOver && (
                    ...
                    >
                        ...
                        <p className="text-pink-400 font-bold text-lg mb-3 flex items-center justify-center gap-1">
                            You collected <span className="text-white text-2xl mx-1">{finalScore.current}</span> hearts! {renderEmojiText("💖")}
                        </p>
